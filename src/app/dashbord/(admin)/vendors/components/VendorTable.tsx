...
import { Eye, Edit, ShieldCheck, XCircle, Ban, Trash2 } from "lucide-react";
      ...
      render: (user: VendorItem) => (
        <div className="flex items-center justify-end gap-1.5">
          ...
          <button
            ...
            title="View Vendor Details (ডিটেইলস দেখুন)"
          ...
          {/* Edit Vendor */}
          <button
            onClick={() => onEditVendor(user)}
            title="Edit Vendor (এডিট করুন)"
            className="p-2 text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-xl transition-all duration-200 active:scale-95 group relative"
          >
            <Edit size={16} />
          </button>
          ...
          {user.status !== "active" && (
            <button
              ...
              title="Activate Vendor (সক্রিয় করুন)"
          ...
          {user.status !== "inactive" && (
            <button
              ...
              title="Deactivate Vendor (নিষ্ক্রিয় করুন)"
          ...
          <button
            ...
            title="Delete Vendor (ডিলিট করুন)"
